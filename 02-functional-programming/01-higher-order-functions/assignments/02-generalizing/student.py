...
strings=["Potato","Aftermath","Boredom","Chicken","Bottle","Dare","Hippopottimus","Annihalation","A"]

numbers=[1,4,19,1987,623,61,0,97,18,458,86,54876267488,69,420,64,21]
...
# print(select_movies_with_actor(movies,"Tom Cruise"))
